...
import { uploaBookCoverPicture } from '../fn/book/uploa-book-cover-picture';
import { UploaBookCoverPicture$Params } from '../fn/book/uploa-book-cover-picture';
...
export class BookService extends BaseService {
  ...
  /** Path part for operation `uploaBookCoverPicture()` */
  static readonly UploaBookCoverPicturePath = '/books/cover/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `uploaBookCoverPicture()` instead.
   *
   * This method sends `multipart/form-data` and handles request body of type `multipart/form-data`.
   */
  uploaBookCoverPicture$Response(params: UploaBookCoverPicture$Params, context?: HttpContext): Observable<StrictHttpResponse<{
}>> {
    return uploaBookCoverPicture(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `uploaBookCoverPicture$Response()` instead.
   *
   * This method sends `multipart/form-data` and handles request body of type `multipart/form-data`.
   */
  uploaBookCoverPicture(params: UploaBookCoverPicture$Params, context?: HttpContext): Observable<{
}> {
    return this.uploaBookCoverPicture$Response(params, context).pipe(
